    ...
    <SafeAreaView className="flex-1 bg-neutral-950">
      ...
      <View className="flex-1 px-5 pt-6">
        ...
        <View className="flex-row items-center justify-between mb-8">
          ...
          <TouchableOpacity className="w-11 h-11 bg-neutral-900 rounded-full items-center justify-center border border-neutral-800">
        ...
        <View className="mt-auto pb-4">
          <TouchableOpacity className="bg-violet-600 rounded-2xl py-4 mb-4">
